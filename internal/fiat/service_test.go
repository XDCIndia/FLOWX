...
func TestInitiateWithdrawal_Success(t *testing.T) {
	...
	svc := NewService(repo, rail, fxSvc, transferSvc, "platform-wallet-123", "flutterwave", "USDC")
...
func TestHandleWebhook_Deposit_Success(t *testing.T) {
	...
	svc := NewService(repo, rail, &mockFXService{}, transferSvc, "platform-wallet-123", "flutterwave", "USDC")
