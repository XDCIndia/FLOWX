...
func (a *ContractWalletAdapter) Faucet(ctx context.Context, walletID, assetCode string, amount decimal.Decimal) (*FaucetResult, error) {
	return nil, fmt.Errorf("faucet not supported for contract wallets")
}
